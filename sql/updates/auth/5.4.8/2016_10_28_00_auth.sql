...
DELETE FROM `rbac_permissions` WHERE `id` IN (631,777,778,779,780,781,782,783,784,785,786);
...
DELETE FROM `rbac_linked_permissions` WHERE `id` = 198 AND `linkedId` IN (631,777,778,779,780,781,782,783,784,785,786);
