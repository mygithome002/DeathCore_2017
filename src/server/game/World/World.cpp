...
void World::LoadConfigSettings(bool reload)
{
    ...
    SetMotd(ConfigMgr::GetStringDefault("Motd", "Welcome to DeathCore."));
	...
	// FAKE PLAYERS
	m_bool_configs[CONFIG_FAKE_PLAYERS_ENABLE]                      = ConfigMgr::GetBoolDefault("FakePlayers.Enable", false);
    ...
    rate_values[VIP_RATE_XP_KILL] = ConfigMgr::GetFloatDefault("Vip.Rate.XP.Kill", 1.0f);
    rate_values[VIP_RATE_XP_QUEST] = ConfigMgr::GetFloatDefault("Vip.Rate.XP.Quest", 1.0f);
    rate_values[VIP_RATE_XP_EXPLORE] = ConfigMgr::GetFloatDefault("Vip.Rate.XP.Explore", 1.0f);
    rate_values[VIP_RATE_HONOR] = ConfigMgr::GetFloatDefault("Vip.Rate.Honor", 1.0f);
    rate_values[VIP_RATE_REPUTATION] = ConfigMgr::GetFloatDefault("Vip.Rate.Reputation", 1.0f);
    rate_values[VIP_RATE_SKILL] = ConfigMgr::GetFloatDefault("Vip.Rate.Skill", 1.0f);
    rate_values[VIP_RATE_CRAFTING] = ConfigMgr::GetFloatDefault("Vip.Rate.Crafting", 1.0f);
    rate_values[VIP_RATE_GATHERING] = ConfigMgr::GetFloatDefault("Vip.Rate.Gathering", 1.0f);
