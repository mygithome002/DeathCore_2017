...
public:
	...
	bool OnGossipHello(Player* plr, Creature* npc)
	{
		...
		plr->ADD_GOSSIP_ITEM(2, "|TInterface\\icons\\Achievement_Reputation_01:30|t  Shop Global", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
		plr->ADD_GOSSIP_ITEM(2, "|TInterface\\icons\\Achievement_Dungeon_AzjolLowercity:30|t Cidades", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
		plr->ADD_GOSSIP_ITEM(2, "|TInterface\\icons\\Achievement_BG_winWSG:30|t  Zona de Duelo", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
		plr->ADD_GOSSIP_ITEM(2, "|TInterface\\icons\\INV_Misc_Wrench_01:30|t  Zona de Profissões", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
		plr->ADD_GOSSIP_ITEM(2, "|TInterface\\icons\\INV_Mask_01:30|t  Zona de Transmogrification", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
		plr->ADD_GOSSIP_ITEM(2, "|TInterface\\icons\\ACHIEVEMENT_ARENA_2V2_1:30|t Arena de Gurubashi", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
		plr->ADD_GOSSIP_ITEM(2, "|TInterface\\icons\\ACHIEVEMENT_GUILDPERK_HONORABLEMENTION:30|t Stolen Treasure - Farmar Honor", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 77);
		plr->ADD_GOSSIP_ITEM(2, "|TInterface\\icons\\Ability_Hunter_MendPet:30|t Zona de Pet de Hunter", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 8);
		plr->ADD_GOSSIP_ITEM(2, "|TInterface\\icons\\Achievement_Zone_TolBarad:30|t Baradin Hold - Raid Cataclysm", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 9);
		plr->ADD_GOSSIP_ITEM(9, "|TInterface\\icons\\Achievement_BG_returnXflags_def_WSG:30|t Close", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 99);
	...
	bool OnGossipSelect(Player* plr, Creature* npc, uint32 sender, uint32 uiAction)
	{
		...
		case GOSSIP_ACTION_INFO_DEF + 2:
			if (plr->GetTeam() == ALLIANCE){
				...
				plr->ADD_GOSSIP_ITEM(9, "|TInterface\\icons\\Achievement_General_CityAttacker:30|t Atacar Orgrimmar", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 14);
				...
				plr->ADD_GOSSIP_ITEM(9, "|TInterface\\icons\\Achievement_General_CityAttacker:30|t Atacar Stormwind", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 19);
				plr->ADD_GOSSIP_ITEM(9, "|TInterface\\icons\\Achievement_BG_returnXflags_def_WSG:30|t Voltar", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 99);
			}
			plr->SEND_GOSSIP_MENU(1, npc->GetGUID());
			break;
		...
		case GOSSIP_ACTION_INFO_DEF + 4: // Zona de Profissões
		...
		case GOSSIP_ACTION_INFO_DEF + 77:
			if (plr->GetTeam() == ALLIANCE){
				...
				plr->ADD_GOSSIP_ITEM(2, "|TInterface\\icons\\Achievement_General_AllianceSlayer:30|t Stolen Treasure: Aliança", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 21);
				plr->ADD_GOSSIP_ITEM(9, "|TInterface\\icons\\Achievement_BG_returnXflags_def_WSG:30|t Voltar", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 99);
			}
			else if (plr->GetTeam() == HORDE){
				plr->ADD_GOSSIP_ITEM(2, "|TInterface\\icons\\Achievement_General_HordeSlayer:30|t Stolen Treasure: Horda", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 22);
				plr->ADD_GOSSIP_ITEM(9, "|TInterface\\icons\\Achievement_BG_returnXflags_def_WSG:30|t Voltar", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 99);
			}
			plr->SEND_GOSSIP_MENU(1, npc->GetGUID());
			break;
		...
		case GOSSIP_ACTION_INFO_DEF + 21: // Stolen Treasure: Aliança
